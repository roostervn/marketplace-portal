...
export default function ComponentPopupUser({ profilesWallet }: Props) {
  const [isClickAvatar, setClickAvatar] = useState(false);
    ...
    <div className="header_avatar">
      ...
      <div className="popup-user">
        <img
          ...
          alt="avatar"
          onClick={() => {
            setClickAvatar(!isClickAvatar);
          }}
        />
        <div
          className={`avatar_popup mt-20 ${!isClickAvatar ? "visible" : ""} `}
        >
          <h4>Your Wallet</h4>
